        ...
        {currentPosts.map((blogPostEntry, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
              <time
                dateTime={blogPostEntry.data.publishDate.toDateString()}
                className="mr-8"
              >
        ...
        <div className="flex flex-row mx-auto container justify-center gap-8">
          {currentPage !== 1 && (
            ...
            >
              ...
              <p className="ml-2 text-[#50A6F2] dark:text-white capitalize">
                {prev}
              </p>
            </button>
          )}
          {currentPage !== totalPages && (
            <button
              ...
              className="flex flex-row align-middle items-center"
            >
              <span className="mr-2 text-[#50A6F2] dark:text-white capitalize">
                {next}
              </span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
